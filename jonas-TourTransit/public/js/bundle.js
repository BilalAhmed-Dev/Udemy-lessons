...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmlsYWxzYWxlbSIsImEiOiJja3NjMW9oOXcwY2NqMnZtY3ltN3V6NW1pIn0.pwfs2_XEWtPe4QlA0r4kwg';
...
},{}],"sign_up.js":[function(require,module,exports) {
"use strict";
...
var sendPassWordResetEmail = /*#__PURE__*/function () {
  ...
  return function sendPassWordResetEmail(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51JQZpYINksYwImgGo56P9ZlgoNXqSMQIUXvTzG44mem0jWEk8E9tDME6gNEHVLThIzJXw4AgJtDUkoAhAuSPJuxG00RdKcxFuE');
...
if (signUpForm) signUpForm.addEventListener('submit', function (e) {
  ...
  (0, _sign_up.signUp)(name, email, password, passwordConfirm);
});
...
if (forgotPassWord) forgotPassWord.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  (0, _forgotPassword.sendPassWordResetEmail)(email);
});
